...
var IAetherPair = _interopDefault(require('@aetherswap/v1-core/build/contracts/IAetherPair.json'));

var addresses = {
	"183": {
	AetherV1Factory: "0x0000000000000000000000000000000000000000",
	Init_Code_Hash: "0x0000000000000000000000000000000000000000",
	owner: "0x0000000000000000000000000000000000000000",
	Multicall2: "0x0000000000000000000000000000000000000000",
	ATRToken: "0x0000000000000000000000000000000000000000",
	WETH: "0x0000000000000000000000000000000000000000",
	SpaceHub: "0x0000000000000000000000000000000000000000",
	Timelock: "0x0000000000000000000000000000000000000000",
	CometSpace: "0x0000000000000000000000000000000000000000",
	AetherVault: "0x0000000000000000000000000000000000000000",
	VaultOwner: "0x0000000000000000000000000000000000000000",
	CometSpaceFactory: "0x0000000000000000000000000000000000000000",
	AetherRouter: "0x0000000000000000000000000000000000000000"
},
	"233": {
	AetherV1Factory: "0x418e214E48Fd88A87692dbDEFb5Ba9598b1fA035",
	Init_Code_Hash: "0xc8f88b53d2846ed869c05b366fc33b84de5ff8bfffcaa0c35ad8a62f2350abd2",
	owner: "0x36bFDe1bFBac808D0025db3F4b2310A9201374b2",
	Multicall2: "0xEE336d7C9B9438110C6049b8956d2e1867D7922b",
	ATRToken: "0x00aa453844E50B21f57f809b90A3526055C2799b",
	WETH: "0x22f92e5a6219bEf9Aa445EBAfBeB498d2EAdBF01",
	SpaceHub: "0xBf40B4a86EEDed01D7782bF6Eead83D239211D0b",
	Timelock: "0xc1f10197eFF1b4bB6E89E308E11f9eaEcAdD30d5",
	CometSpace: "0x924A89aA6968eCFAF3AeF37cD7F385467DE7C520",
	AetherVault: "0x7F45a8390F439387b5CE806acB31E130fE742E16",
	VaultOwner: "0xd249236458B9bDBb396DfB982673C5f9e77aD002",
	CometSpaceFactory: "0x7637cF4AdE0beFAadecadf2D8b485E75dd16a9B4",
	AetherRouter: "0x913c08B4C2Cfa61f867f93664b25746f8037D97F",
	WBTC: "0x778Fe591DdBA7d9E4771eC5B2979926C7403d6D1",
	USDC: "0x06B468AAbdD02033B2BBdFa2306300b9515363Ca",
	USDT: "0x3618B058a7fb6638003C8de41d152e9A73aBCC71",
	DAI: "0x9Cfb5595cad475cEB506631C6e898a48c4F4CeE6",
	WERN: "0x61A96ADf813E0f34CE3857a72f0E3bdFce8f81b8"
}
};

var _SOLIDITY_TYPE_MAXIMA;
(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 183] = "MAINNET";
  ChainId[ChainId["TESTNET"] = 233] = "TESTNET";
...
var FACTORY_ADDRESS = addresses[DEFAULT_CHAIN_ID].AetherV1Factory;
var INIT_CODE_HASH = addresses[DEFAULT_CHAIN_ID].Init_Code_Hash;
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'Aetherswap-LP', 'Aetherswap LPs');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Aether Router, and has static methods for helping execute trades.
 */
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.TESTNET] = {}, _TOKEN_DECIMALS_CACHE);
/**
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IAetherPair.abi, provider).getReserves()).then(function (_ref) {
...
//# sourceMappingURL=v1-sdk.cjs.development.js.map
