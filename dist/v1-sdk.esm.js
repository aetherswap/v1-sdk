...
import IAetherPair from '@aetherswap/v1-core/build/contracts/IAetherPair.json';
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[ChainId.TESTNET] = {}, _TOKEN_DECIMALS_CACHE);
/**
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IAetherPair.abi, provider).getReserves()).then(function (_ref) {
